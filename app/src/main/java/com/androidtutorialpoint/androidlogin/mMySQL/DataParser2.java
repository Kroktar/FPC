...
/**
 * Created by germa on 07-05-2017.
 */
...
public class DataParser2 extends AsyncTask<Void,Void,Integer> {
    ...
    public DataParser2(Context c, Spinner sp, String jsonData) {
        this.c = c;
        this.sp = sp;
...
//            spacecrafts.add("Nueva Mascota");
            ...
            for(int i=0;i<ja.length();i++)
            {
                ...
                int id=jo.getInt("rut");
                String name=jo.getString("nombre")+" "+jo.getString("apellido");
